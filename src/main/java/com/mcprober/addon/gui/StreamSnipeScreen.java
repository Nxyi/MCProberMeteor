...
import com.mcprober.addon.system.StreamSnipeBuilder;
...
public class StreamSnipeScreen extends WindowScreen {
    private static StreamSnipeScreen instance = null;
    ...
    public static StreamSnipeScreen instance(MultiplayerScreen multiplayerScreen, Screen parent) {
        if (instance == null) {
            instance = new StreamSnipeScreen();
        }
    ...
    public StreamSnipeScreen() {
        super(GuiThemes.get(), "StreamSnipe");
    }
    ...
    public void initWidgets() {
        ...
        add(theme.button("search")).expandX().widget().action = () -> {
            ...
            CompletableFuture.supplyAsync(() -> {
                ...
                StreamSnipeBuilder.SearchParams flags = new StreamSnipeBuilder.SearchParams(viewerCountSetting.get(), languageSetting.get(), modSetting.get(), tagsSetting.get());
